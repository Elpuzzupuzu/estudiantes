...
import { logoutUser } from "../../features/usuarios/usuariosSlice";
import { Menu, X, GraduationCap, Users, BookOpen, Calendar, Award, Bell, LogOut } from "lucide-react";
...
const SaekoLogo = ({ className = "w-10 h-10" }) => (
  ...
  >
    <path
      d="M32 8 L48 16 L48 32 C48 42 40 50 32 56 C24 50 16 42 16 32 L16 16 Z"
      fill="url(#gradient)"
      stroke="#1E293B"
      strokeWidth="2"
    />
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              {user ? (
                <button
                  ...
                  className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-2"
                >
                ...
                <Link
                  to="/login"
                  className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md"
                >
                  Portal Alumno
                </Link>
              )}
            ...
            <div className="sticky top-0 bg-gradient-to-br from-white to-slate-50 p-5 border-b border-slate-200 z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-slate-800 font-bold text-xl block">
                      Saeko 2
                    </span>
            ...
            <div className="p-5">
              ...
              <div className="mt-6 pt-6 border-t border-slate-200 flex flex-col gap-3">
                {user ? (
                  <button
                    onClick={handleLogout}
                    className="w-full px-4 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2"
                  >
                    <LogOut className="w-5 h-5" />
                    Cerrar sesión
                  </button>
                  ...
                  <Link
                    to="/login"
                    className="w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2"
                  >
